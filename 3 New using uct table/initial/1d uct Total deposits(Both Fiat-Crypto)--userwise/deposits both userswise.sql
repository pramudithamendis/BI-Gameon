...
drop table total_deposits_both_daily_userwise;

CREATE TABLE total_deposits_both_daily_userwise (
...
select * from total_deposits_both_daily_userwise;

SET @cutoff := '2025-09-27 18:30:00'; 
insert into total_deposits_both_daily_userwise(user_id, email, first_name, last_name, date_, total_completed_amount, total_transactions) 
...
select * from total_deposits_both_total_userwise;

select * from total_deposits_both_weekly_userwise;

drop table total_deposits_both_weekly_userwise;
CREATE TABLE total_deposits_both_weekly_userwise (
...
drop table total_deposits_both_monthly_userwise;
select * from total_deposits_both_monthly_userwise;
...
CREATE TABLE total_deposits_both_monthly_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
    email VARCHAR(255) NOT NULL,
...
select * from total_deposits_both_total_userwise;
drop table total_deposits_both_total_userwise;
