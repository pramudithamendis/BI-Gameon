...
drop table uct_total_withdrawals_both_daily;
CREATE TABLE uct_total_withdrawals_both_daily (
...
select * from uct_total_withdrawals_both_daily;
...
drop table uct_total_withdrawals_both_weekly;
CREATE TABLE uct_total_withdrawals_both_weekly (
...
select * from uct_total_withdrawals_both_weekly;
...
drop table total_withdrawals_both_monthly;
CREATE TABLE total_withdrawals_both_monthly (
...
drop table total_withdrawals_both_total;
CREATE TABLE total_withdrawals_both_total (
...
select * from total_withdrawals_both_total;
