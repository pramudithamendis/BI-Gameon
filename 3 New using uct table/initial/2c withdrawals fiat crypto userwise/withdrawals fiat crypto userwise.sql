...
CREATE TABLE total_withdrawals_fiat_daily_userwise (
...
drop table total_withdrawals_fiat_weekly_userwise;
CREATE TABLE total_withdrawals_fiat_weekly_userwise (
...
CREATE TABLE total_withdrawals_fiat_monthly_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
    email VARCHAR(255) NOT NULL,
...
select * from total_withdrawals_fiat_total_userwise;
drop table total_withdrawals_fiat_total_userwise;
CREATE TABLE total_withdrawals_fiat_total_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
///////////////////
drop table total_withdrawals_crypto_daily_userwise;

CREATE TABLE total_withdrawals_crypto_daily_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL ,
    email VARCHAR(255) NOT NULL ,
    first_name VARCHAR(255),
...
drop table total_withdrawals_crypto_weekly_userwise;
CREATE TABLE total_withdrawals_crypto_weekly_userwise (
    id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT UNSIGNED NOT NULL,
    email VARCHAR(255) NOT NULL,
    first_name VARCHAR(150) NULL,
...
CREATE TABLE total_withdrawals_crypto_monthly_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
    email VARCHAR(255) NOT NULL,
    first_name VARCHAR(100),
...
select * from total_withdrawals_crypto_total_userwise;
drop table total_withdrawals_crypto_total_userwise;
CREATE TABLE total_withdrawals_crypto_total_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL unique,
    email VARCHAR(255) NOT NULL,
    first_name VARCHAR(150),
