...
drop table total_withdrawals_both_daily_userwise;

CREATE TABLE total_withdrawals_both_daily_userwise (
...
select * from total_withdrawals_both_daily_userwise;

SET @cutoff := '2025-09-27 18:30:00'; 
insert into total_withdrawals_both_daily_userwise(user_id, email, first_name, last_name, date_, total_completed_amount, total_transactions) 
...
select * from total_withdrawals_both_total_userwise;

select * from total_withdrawals_both_weekly_userwise;

drop table total_withdrawals_both_weekly_userwise;
CREATE TABLE total_withdrawals_both_weekly_userwise (
...
select * from total_withdrawals_both_weekly_userwise;
SET @cutoff := '2025-09-27 18:30:00'; 
insert into total_withdrawals_both_weekly_userwise(user_id, email,first_name,last_name,year,week_number,week_label,total_completed_amount,total_transactions) 
SELECT w.user AS user_id,
 u.email, 
 u.first_name, 
 u.last_name, 
...
drop table total_withdrawals_both_monthly_userwise;
select * from total_withdrawals_both_monthly_userwise;
...
CREATE TABLE total_withdrawals_both_monthly_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    user_id BIGINT NOT NULL,
    email VARCHAR(255) NOT NULL,
...
select * from total_withdrawals_both_monthly_userwise;
SET @cutoff := '2025-09-27 18:30:00'; 
insert into total_withdrawals_both_monthly_userwise(user_id,email,first_name,last_name,month_,total_completed_amount,total_transactions) 
...
select * from total_withdrawals_both_total_userwise;
drop table total_withdrawals_both_total_userwise;
CREATE TABLE total_withdrawals_both_total_userwise (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
...
SET @cutoff := '2025-09-27 18:30:00'; 
insert into total_withdrawals_both_total_userwise(user_id,email,first_name,last_name,total_completed_amount,total_transactions) 
